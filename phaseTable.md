...
| **10** | Investigação de APIs (2d), integração (1d), cache/fallback, cron jobs |
...
| 10 | Dados FipeZap/CUB reais no resultado (não mock) |
...
| 10 | **[CRÍTICO]** APIs confirmadas públicas, cache funciona, fallback testado |
| 11 | Onboarding visível, mobile sem scroll horizontal |
| 12 | E2E passa, CI/CD pipeline verde |
